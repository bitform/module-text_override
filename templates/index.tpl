{include file='modules_header.tpl'}
  ...
  <tr>
    <td width="45"><img src="images/icon_text_override.gif" width="34" height="34" /></td>
      ...
      {foreach from=$overridden_strings item=info name=row}
        ...
        <div id="row_{$count}">
					...
					<tr>
						...
						<td><input type="text" name="{$count}" id="string_{$count}" value="{$info.original_string|escape}" readonly style="width:99%" /></td>
					</tr>
					<tr>
  ...
  {if $overridden_strings|@count == 0}
    to_ns.num_rows = 0;
    {literal}Event.observe(window, "dom:loaded", function() { to_ns.add_row(); });{/literal}
  {else}
  ...
  <div style="display:none">
    ...
    <div id="row_template">
      ...
      <tr>
        <td class="pad_left_small">{$LANG.word_string}</td>
        <td><input type="text" name="string_%%ROW%%" id="string_%%ROW%%" style="width:99%" readonly /></td>
      </tr>
      <tr>
        <td class="pad_left_small">{$L.phrase_overridden_string}</td>
